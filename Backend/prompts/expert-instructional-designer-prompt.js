...
1. **Domain Classification**:
   - Analyze content carefully and identify the MOST SPECIFIC domain that matches
   - Available domains: Healthcare & Medical, Technology & IT, Finance & Banking, Education & Academic, Manufacturing & Operations, Compliance & Regulatory, Sales & Marketing, Human Resources, Business & Management
   - ONLY classify as "Business & Management" if content is genuinely about general business operations, management principles, or leadership - NOT as a fallback
   - For technical content about programming/software: use "Technology & IT"
   - For healthcare/medical content: use "Healthcare & Medical"
   - For finance/banking content: use "Finance & Banking"
   - Provide clear reasoning: "This content is classified as [SPECIFIC DOMAIN] because it contains [SPECIFIC EVIDENCE] such as [EXAMPLES FROM CONTENT]"
