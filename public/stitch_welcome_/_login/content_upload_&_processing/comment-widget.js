/**
 * Universal Comment Widget - Add to Any Page
 * Like Figma's commenting system
 */
    ...
    createFeedbackPanel() {
        ...
        this.feedbackPanel.innerHTML = `
            <div class="comment-panel-header">
                ...
                <button class="comment-close" onclick="commentWidget.closeFeedbackPanel()">×</button>
            </div>
            <div class="comment-panel-content">
                <form class="comment-form" onsubmit="commentWidget.submitComment(event)">
